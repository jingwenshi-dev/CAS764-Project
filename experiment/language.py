...
def api_call(folder: str, datasets: list, remove_cols: list, sample_num: int, sample_random_state: int, test_num: int, test_random_state, i):
    ...
    _, test_set = extract_data('../dataset/clean/afrd-arabic-fake-reviews-detection/', datasets, remove_cols, sample_num, sample_random_state, test_num,
                                    test_random_state)
    ...
    for dataset in test_set:
        ...
        output_path = f'./results/language/{i}/'
